<div class="column">
    <img src="img/Adultos.jpg" alt="" class="img-galeria">  
...
<div class="column">
    <img src="img/Couple1.jpg" alt="" class="img-galeria">
...
<div class="column">
    <img src="img/Niños.jpg" alt="" class="img-galeria">
...
<div class="column">
    <img src="img/Smile.jpg" alt="" class="img-galeria">
...
<div class="column">
    <img src="img/Estres.jpg" alt="" class="img-galeria">
...
<div class="column">
    <img src="img/Online.jpg" alt="" class="img-galeria">
...
<script>
     $('.column').hover(
    function() {
        $(this).children("figcaption").slideDown('fast','swing');
    }, function(){
        $(this).children("figcaption").slideUp('fast');
    });
